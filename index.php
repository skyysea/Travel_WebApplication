                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6 ">
                                    <div class="detail-box">
                                        ...
                                        <p>
                                        Variety of places Guaranteed by Voya that will make you feel fun. be happy every day.
                                        </p>
                                        <div class="btn-box">
                                            <a href="loca.php" class="btn1">
                        Visit Now
                      </a>
                                        </div>
                                    </div>
        ...
        <div class="container">
            ...
            <div class="filters-content">
                <div class="row grid">
                    ...
                    <div class="col-sm-6 col-lg-4 all Location">
                        <div class="box">
                            <div>
                                <div class="img-box">
