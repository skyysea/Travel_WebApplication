            ...
            <div class="row">   
                ...
                <div class="col-md-6">
                    <div class="detail-box">
                        ...
                        <p>
                        IMPACT Lakeside over 150,000 sq meters outdoor space set against the magnificent backdrop of a beautiful lake suitable for innovative outdoor events - day or night

152,450 sq meters of outdoor space set against the magnificent backdrop of Muang Thong Thani fresh water lake - an ideal outdoor venue for innovative outdoor events - day or night, be it amusement park, sporting events, night bazaars, fire works, festivals, concerts and many more
.
                        </p>
                        <a href="http://www.impact.co.th/index.php/facilities/impactlakeside">
                            Read More
                        </a>
                        <?php  if(isset($_SESSION['username'])) : ?>
                            ...
                            <form action="favorite_db.php" method="post">
                                ...
                                <input type="hidden" name="img_id" id="img_id" value="images/L02.jpg">
                                <input type="hidden" name="name" id="name" value="IMPACT Lakeside">
                                <input type="hidden" name="link" id="link" value="LC02.php">
                                <a><input type="submit" name="submit" id="submit" class="btn" value="Favorite"></a>
                            </form>
                            <?php endif ?>
                            <?php  if(isset($_SESSION['unfavorite'])) : ?>
                            <form action="favorite_db.php" method="post">
                                <input type="hidden" name="page_dele" id="page_dele" value="5">
                    ...
                    <div class="footer_contact">
                        ...
                        <div class="contact_link_box">
                            <a>
                                ...
                                <span>
                                IMPACT Lakeside, Popular Road, Ban Mai Subdistrict, Pak Kret District, Nonthaburi 11120
              </span>
                            </a><a> </a><a> </a><a> </a><a> </a><a>
                            </a>
                            <a>
