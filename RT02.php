            ...
            <div class="row">   
                ...
                <div class="col-md-6">
                    <div class="detail-box">
                        ...
                        <p>
                        Mae La Kitchen Thai restaurant in Muang Thong Good atmosphere for heart. There are both indoor and outdoor zones. Anyone who likes the atmosphere in the garden can sit and chill or sit in the air-conditioned room. It's just as chill. Because here they have deliciousness as the protagonist of every menu, every dish. at a friendly price Remove the picture of a big restaurant and have to pay a high price. because here the quality is really worth the price
.
                        </p>
                        <a href="https://www.facebook.com/maelakitchen">
                            Read More
                        </a>
                        <?php  if(isset($_SESSION['username'])) : ?>
                            ...
                            <form action="favorite_db.php" method="post">
                                ...
                                <input type="hidden" name="img_id" id="img_id" value="images/G02.jpg">
                                <input type="hidden" name="name" id="name" value="Mae-la Kitchen">
                                <input type="hidden" name="link" id="link" value="RT02.php">
                                <a><input type="submit" name="submit" id="submit" class="btn" value="Favorite"></a>
                            </form>
                            <?php endif ?>
                            <?php  if(isset($_SESSION['unfavorite'])) : ?>
                            <form action="favorite_db.php" method="post">
                                <input type="hidden" name="page_dele" id="page_dele" value="2">
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="footer_contact">
                        ...
                        <div class="contact_link_box">
                            <a>
                                ...
                                <span>
                                50 683 Soi Muang Thong Thani, Bang Phut Subdistrict, Pak Kret District, Nonthaburi 11120
              </span>
                            </a><a> </a><a> </a><a> </a><a> </a><a>
                            </a>
                            <a>
                ...
                <div class="col-md-4 footer-col">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3872.78270753606!2d100.54014941483229!3d13.911932440244017!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e2837723f5b1bf%3A0xc16e13b4e509a96f!2z4Lin4Lix4LiU4Lic4Liy4Liq4Li44LiB4Lih4LiT4Li14LiI4Lix4LiB4Lij!5e0!3m2!1sth!2sth!4v1669495617147!5m2!1sth!2sth"
